...
# UI Cleanup
 - [x] make video stream centered and main focus of page
 - [x] add a fullscreen button for the stream
 - [x] make stream controls overlay the stream video to save space (basically making a web player here with custom UI)
 ...
 - [x] need shimmer or spinner loader for stream and shimmer loader for camera tiles
